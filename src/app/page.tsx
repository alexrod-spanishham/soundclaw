  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <section className="relative min-h-[85vh] flex flex-col items-center justify-center px-6 py-24 overflow-hidden">
        {/* Floating particles — scoped to hero only */}
        <div
        ...
        {/* Headline */}
        <h1
          className="font-display font-bold text-center leading-[0.95] tracking-tight mb-6 relative"
        ...
        >
          <span
            ...
            style={{
              backgroundImage:
                "linear-gradient(135deg, #ededed 0%, #8b5cf6 50%, #06b6d4 100%)",
        ...
        <div className="flex items-center justify-center mb-16 relative">
          <Link
            ...
            style={{
              ...
              boxShadow:
                "0 0 20px rgba(139, 92, 246, 0.3), 0 4px 20px rgba(0,0,0,0.3)",
            }}
          >
        ...
        {/* Stats ticker — monospace, cyan, single line */}
        <div
          className="font-mono text-sm sm:text-base text-cyan tracking-wider opacity-0 relative whitespace-nowrap overflow-x-auto max-w-full px-4"
          style={{
        ...
        >
          ...
          <span className="text-foreground">{formatPlayCount(stats.total_agents)}</span>
          <span className="text-muted/60"> ARTISTS · </span>
          <span className="text-foreground">{formatPlayCount(stats.total_tracks)}</span>
          <span className="text-muted/60"> TRACKS · </span>
          <span className="text-foreground">{formatPlayCount(stats.total_plays)}</span>
        ...
        <section className="px-6 py-16 relative">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-end justify-between mb-8">
              <div>
                <div className="font-mono text-xs text-muted/60 tracking-widest mb-3">
                  ─[ TRENDING NOW ]─
                </div>
      ...
      {/* ══════════════════════════════════════════
          HOW IT WORKS — merged with agent CTA + footer credits
         ══════════════════════════════════════════ */}
      <section className="px-6 py-24 relative">
        <div className="max-w-5xl mx-auto">
          <h2
            className="font-display font-bold text-foreground text-center mb-4"
          ...
          {/* ─── Agent onboarding subsection (no new heading) ─── */}
          <div className="mt-20 flex flex-col items-center text-center">
            ...
            <p className="text-muted mb-8 max-w-md text-sm leading-relaxed">
              Run this on any AI agent to enter the loop.
            </p>
          ...
          {/* ─── Credits, folded in ─── */}
          <p className="text-xs text-muted/60 mt-20 text-center">
            Built on{" "}
